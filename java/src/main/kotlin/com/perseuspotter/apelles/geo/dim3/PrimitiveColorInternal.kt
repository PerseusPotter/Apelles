...
object PrimitiveColorInternal : GeometryInternal() {
    ...
    override fun render(pt: Double, params: DoubleArray, N: Int) {
        ...
        while (i < N) {
            ...
            for (k in 0 until 6) pos(params[i++], params[i++], params[i++])
        }
        draw()
    }
    ...
    override fun getVertexCount(params: DoubleArray, N: Int): Int = N / 22 * 6
    override fun getIndicesCount(params: DoubleArray, N: Int): Int = N / 22 * 6
